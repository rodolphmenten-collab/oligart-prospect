...
function messageFor(p){const name=p.contactName?` ${p.contactName}`:'';return `Bonjour${name},\n\nJe me permets de vous contacter au sujet de la stratégie média digitale de ${p.company}.\n\nChez Oligart, j’accompagne des annonceurs sur leur stratégie d’achat media 360° (display, social, vidéo, DOOH, audio, programmatique) — en structurant les achats en direct, avec des honoraires transparents et un format plus flexible qu’une agence traditionnelle.\n\nJe serais ravi d’échanger 20 minutes pour voir comment optimiser votre approche média actuelle et identifier les leviers d’économies possibles.\n\nMon site : https://oligart-agency.com\n\nBien à vous,\nRodolph Menten`}
