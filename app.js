...
function messageFor(p){
 ...
 if(AGENCY_CATEGORIES.includes(p.category)){
  return `Bonjour${name},\n\nJe me lance en freelance/conseil pour accompagner les agences media indépendantes sur le business development et le management commercial — avec un delta concret : un accès direct à de meilleures conditions d'achat media (partenariat plateforme AdTech), et un outil de prospection déjà opérationnel que je peux mettre à disposition.\n\nSi ça peut avoir du sens pour ${p.company}, je suis dispo pour en discuter 15-20 minutes.\n\nMon site : https://oligart-agency.com\n\nBien à vous,\nRodolph Menten`;
 }
